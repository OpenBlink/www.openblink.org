const translations = {
  ...
  "zh-CN": {
    ...
    "tools.webide.stable": "0.3.5（稳定版）",
    "tools.webide.legacy": "0.3.4（旧版）",
    "tools.webide.canary.title": "Canary版本",
    "tools.webide.canary.desc": "最新实验性功能。可能不稳定。",
    "tools.webide.stable.title": "版本0.3.5",
    "tools.webide.stable.desc": "当前稳定版本，支持WebSimulator。",
    "tools.webide.legacy.title": "版本0.3.4",
  ...
  "zh-TW": {
    ...
    "tools.webide.stable": "0.3.5（穩定版）",
    "tools.webide.legacy": "0.3.4（舊版）",
    "tools.webide.canary.title": "Canary版本",
  ...
  "ja-easy": {
    ...
    "tools.webide.stable": "0.3.5（<ruby>安定版<rt>あんていばん</rt></ruby>）",
    "tools.webide.legacy": "0.3.4（<ruby>古<rt>ふる</rt></ruby>いバージョン）",
    "tools.webide.canary.title": "Canaryビルド",
